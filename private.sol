...
contract TokenPresaleBridge is Ownable {
    ...
    uint256 public tokensPerBnb = ___*1e18; // set tokens per bnb
    uint256 public maxBnbAmount = ___*1e18;
    uint256 public minBnbAmount = ___*1e17;
    uint256 public totalBnbCap = ___*1e18;
    uint256 public totalPurchasedAmount;
    bool public isInitialized = false;
    address public tokenAddress;
    
    constructor() {
        address token = address(________________________); // Add token Token (update before deploying)
